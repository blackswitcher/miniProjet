...
n <input type="number" name="chiffre" placeholder="entre 0 et 1000" values=" htmlentities($_GET['chiffre']) -->
    ...
    <form action="/jeu.php" method="GET">
        <?php
        // Vérification des données dans $_GET pour afficher un message d'erreur
        if ($_SERVER['REQUEST_METHOD'] === 'GET' && empty($_GET['parfum'])): ?>
            <div class="alert alert-danger">
                Vous n'avez sélectionné aucun parfum.
            </div>
        <?php endif; ?>
